...
export default function Process2_2() {
    return (
        <div>
            <section id="process-2" className="wide-60 process-section division">
                <div className="container">
                    {/* SECTION TITLE */}
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1 section-title">
                            {/* Title 	*/}
                            <h3 className="h3-lg">Manage All Your Contact Information</h3>
                            {/* Text */}
                        ...
                        <ul className="processbar">
                            ...
                            <li id="step-3" className="col-md-4">
                                <div className="pbox-2 text-center">
                                    ...
                                    {/* Text */}
                                    <h5 className="h5-sm">Get Connection</h5>
                                    <p>Nemo ipsam egestas volute fugit dolores quaerat sodales</p>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="process-btn">
                                <p><a href="#info-10" className="internal-link process-link">Discover more about <span>NextApp
                                    Process</span></a></p>
                            </div>
                        </div>
                    </div>
