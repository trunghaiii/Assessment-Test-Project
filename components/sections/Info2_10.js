...
export default function Info2_10() {
    return (
        <div>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="img-block pl-45 mb-40 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                                <img className="img-fluid" src="images/image-17.png" alt="info-image" />
                            </div>
                        </div>
                        {/* TEXT BLOCK */}
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                {/* Title */}
                                <h3 className="h3-lg">System and selective scanning for viruses</h3>
                                {/* List */}
                                ...
                                {/* Button */}
                                <a href="#download-1" className="btn btn-tra-grey black-hover">
                                    Download NextApp
                                </a>
                            </div>
                        </div> {/* END TEXT BLOCK */}
