...
export default function Info1_9() {
    return (
        <>
            <section id="info-1" className="info-2-row bg-lightgrey wide-60 info-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                {/* Title */}
                                <h3 className="h3-lg">Create groups, add contacts by own</h3>
                                {/* List */}
