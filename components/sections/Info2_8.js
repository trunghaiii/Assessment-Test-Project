...
export default function Info2_8() {
    return (
        <div>
            <section id="info-2" className="info-2-row wide-60 info-section division">
                <div className="container">
                    <div className="row d-flex align-items-center">
                        {/* IMAGE BLOCK */}
                        <div className="col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                            <div className="img-block pl-45 mb-40">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                {/* Title */}
                                <h3 className="h3-lg">Share tasks  lists with your friends</h3>
                                {/* List */}
