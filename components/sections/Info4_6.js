...
export default function Info4_6() {
    return (
        <div>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                {/* Title */}
                                <h3 className="h3-lg">Keep your disk space organized</h3>
                                {/* List */}
                                <ul className="txt-list mb-35">
                                    ...
                                    <li>Sagittis congue augue egestas volutpat egestas magna feugiat primis ultrice
