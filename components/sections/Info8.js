...
export default function Info8({ style }) {
    return (
        <>
            <section id="info-8" className="info-8-row bg-map bg-dark bg-fixed pt-100 info-section division">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-10 offset-lg-1">
                            <div className="txt-block text-center mb-50 wow fadeInUp" data-wow-delay="0.3s">
                                {/* Title */}
                                <h3 className="h3-lg">Start Tracking Your Money With NextApp!</h3>
                                {/* Text */}
