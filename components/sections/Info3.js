...
export default function Info3({ style }) {
    return (
        <>
            <section id="info-3" className="info-3-row pt-100 info-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                {/* Section ID */}
                                <span className="section-id id-color">Encrypted Messaging</span>
                                {/* Title */}
                                <h3 className="h3-lg">Sync your messages</h3>
                                {/* Text */}
                        ...
                        <div className="col-md-6">
                            <div className="img-block pc-45 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                                <img className="img-fluid" src="/images/image-08.png" alt="info-image" />
                            </div>
                        </div>
                    </div> {/* End row */}
                </div> {/* End container */}
