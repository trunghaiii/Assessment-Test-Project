...
export default function Pricing2({ style }) {
    return (
        <>
                    ...
                    <div className="row pricing-row">
                        ...
                        <div className="col-md-4">
                            <div className="pricing-table highlight">
                                ...
                                {/* Button */}
                                <Link href="#" className="btn btn-yellow black-hover">Get Started</Link>
                            </div>
                        ...
                        <div className="col-md-4">
                            <div className="pricing-table">
                                {/* Icon  */}
                                <div className="price-icon">
                                    <img className="img-130" src="/images/icons/flight-grey.png" alt="price-icon" />
                                </div>
                                {/* Plan Price  */}
                                <div className="pricing-plan">
