...
export default function Info2_4() {
    return (
        <div>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-45 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                {/* Title */}
                                <h3 className="h3-lg">Work faster with powerful filters</h3>
                                {/* List */}
                                ...
                                {/* Button */}
                                <a href="#process-1" className="btn btn-tra-grey black-hover">Learn More About It</a>
                            </div>
                        </div> {/* END TEXT BLOCK */}
                    </div> {/* End row */}
                </div> {/* End container */}
